...
head (cherry)
cvolume <- cherry$volume
cdiameter <- cherry$diameter
plot (cvolume ~ cdiameter)
############################ simple estimate ###################################
N <- 2967
...
B_v2d <- srs_ratio_est (ydata = cvolume, xdata = cdiameter, N = 2967)
B_v2d
...
# simple estimate
srs_mean_est (cvolume, N = 2967) * 2967
